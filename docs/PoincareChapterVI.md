...
2. Implement the `ChapterVIDPrincipalThreeArcContinuation` interface from the explicit §97 pole
   paths: construct the source-sheet deformation and prove its two outer arcs are `o(-log k)`.
