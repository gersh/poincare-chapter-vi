...
source derivatives obtained from rotating the physical second ellipse. The remaining
algebraic-geometric task is now the preceding deformation-to-vanishing bridge: it must justify
from Poincaré's singular-locus hypotheses that the relevant infinitesimal derivative vanishes at
all 24 certified points.
