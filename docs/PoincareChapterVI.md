...
the source sextic and septic have exactly 24 distinct non-origin affine common zeros. The
remaining algebraic-geometric task is the deformation/rank implication: it must justify why these
points persist with the claimed multiplicities for the varied sextic and why the resulting excess
intersection forces projective invariance.
