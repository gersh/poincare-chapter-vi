...
- carrying the now-certified synchronized collision branches into the actual source-sheet
  integration cycle and proving that its deformation realizes the resulting double pinch;
